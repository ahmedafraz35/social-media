...
export class AIService {
  ...
  private readonly smartUrl = 'https://api-inference.huggingface.co/models/bigscience/bloom-560m';
  ...
  private tryMultipleModels(message: string, language: string): Observable<AIResponse> {
    const models = [this.primaryUrl, this.conversationalUrl, this.fallbackUrl, this.smartUrl];
